...
import com.perples.recosample.core.registration.RegisterContract;
import com.perples.recosample.core.registration.RegisterPresenter;
import com.perples.recosample.core.users.add.AddUserContract;
import com.perples.recosample.core.users.add.AddUserPresenter;
...
public class RegisterFragment extends Fragment implements View.OnClickListener, RegisterContract.View, AddUserContract.View {
    ...
    private void bindViews(View view) {
        ...
        //mETxtChatName = (EditText) view.findViewById(R.id.edit_text_chat_name);
    ...
    private void onRegister(View view) {
        ...
        //String chatName = mETxtChatName.getText().toString();
